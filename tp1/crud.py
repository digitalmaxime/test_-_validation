...
class CRUD:
    ...
    def add_new_user(self, user_email, date):
        ...
        if self.user_counter == 1:
            ...
            with open(self.groups_file, "w") as group_file_write:
                json.dump(data, group_file_write, indent = 4)
        ...
        users_data[self.user_counter] = data
    ...
    def add_new_group(self, name, trust, members_list):
        ...
        #default est le 1e groupe donc on ajoute 1 au compteur
        key = self.group_counter + 1
