...
# crud.add_new_group('amies', 49, []) # a regler
# print(crud.get_group_id("amies"))

# crud.add_new_user("maude@email.com", "2020-11-23")
# print("group counter: ", crud.group_counter)
# crud.add_new_user("maude@email.com", "2020-11-23")
# print("group counter: ", crud.group_counter)
# crud.add_new_user("maude@email.com", "2020-11-23")
# print("group counter: ", crud.group_counter)

# crud.add_new_group("amies", 48, ["maude@email.com"])
# print("group counter: ", crud.group_counter)
