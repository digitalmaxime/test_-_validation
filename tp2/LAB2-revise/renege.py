...
class RENEGE:
    ...
    def classify_emails(self): #pragma: no cover
        '''
        ...
        print("crud clean files a bien fonctionne! *******")
        try:
            self.process_email(self.get_email())
            return True
        except Exception as e:
            print("Error!", e.__class__, "occurred at line 32.")
            return False


    def process_email(self, new_emails):     #pragma: no cover
        '''
    ...
    def calculate_trust_user(index): #pragma: no cover
        index = "{}".format(index)
